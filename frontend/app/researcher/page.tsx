...
export default function ResearcherPage() {
  return (
    <div className="container mx-auto py-10">
      ...
      <p className="mb-4">This research project is being conducted by <strong>Md Shihabul Islam</strong>, BSc in Engineering in Mechatronics Engineering from Rajshahi University of Engineering & Technology (RUET).</p>
      ...
      <p className="font-medium">Email: <a href="mailto:mdshihabulislam.mte.ruet@gmail.com" className="text-primary">mdshihabulislam.mte.ruet@gmail.com</a></p>
